...
export const concepts: Concept[] = [
  ...
  concept("please", "A1", "word", "please", "s'il vous plaît", "politeness", "A coffee, please.", "Un café, s'il vous plaît."),
  concept("thank-you", "A1", "expression", "thank you", "merci", "politeness", "Thank you for your help.", "Merci pour ton aide."),
  concept("excuse-me", "A1", "expression", "excuse me", "excusez-moi", "politeness", "Excuse me, where is the station?", "Excusez-moi, où est la gare ?"),
  concept("i-need", "A1", "construction", "I need…", "j'ai besoin de…", "needs", "I need some water.", "J'ai besoin d'eau."),
  concept("i-want", "A1", "construction", "I want…", "je veux…", "needs", "I want a ticket.", "Je veux un billet."),
  concept("can-i", "A1", "construction", "Can I…?", "est-ce que je peux… ?", "requests", "Can I sit here?", "Est-ce que je peux m'asseoir ici ?"),
  concept("what-time", "A1", "construction", "What time…?", "à quelle heure… ?", "time", "What time does it start?", "À quelle heure cela commence-t-il ?"),
  concept("today", "A1", "word", "today", "aujourd'hui", "time", "I work today.", "Je travaille aujourd'hui."),
  concept("tomorrow", "A1", "word", "tomorrow", "demain", "time", "See you tomorrow.", "À demain."),
  concept("over-here", "A1", "expression", "over here", "par ici", "place", "The seats are over here.", "Les places sont par ici."),
  concept("over-there", "A1", "expression", "over there", "là-bas", "place", "The bus stop is over there.", "L'arrêt de bus est là-bas."),
  concept("i-like", "A1", "construction", "I like…", "j'aime…", "preferences", "I like this song.", "J'aime cette chanson."),
  ...
  concept("would-like", "A2", "construction", "I'd like…", "j'aimerais…", "requests", "I'd like a table for two.", "J'aimerais une table pour deux."),
  concept("have-to", "A2", "grammar", "have to", "devoir", "obligation", "I have to leave early.", "Je dois partir tôt."),
  concept("looking-for", "A2", "phrasal_verb", "look for", "chercher", "city", "I'm looking for the pharmacy.", "Je cherche la pharmacie."),
  concept("could-you", "A2", "construction", "Could you…?", "pourriez-vous… ?", "requests", "Could you help me, please?", "Pourriez-vous m'aider, s'il vous plaît ?"),
  concept("why-dont-we", "A2", "construction", "Why don't we…?", "pourquoi ne pas… ?", "plans", "Why don't we meet outside?", "Pourquoi ne pas nous retrouver dehors ?"),
  concept("prefer-to", "A2", "construction", "prefer to", "préférer", "preferences", "I prefer to walk.", "Je préfère marcher."),
  concept("before", "A2", "word", "before", "avant", "time", "Call me before you leave.", "Appelle-moi avant de partir."),
  concept("after-that", "A2", "expression", "after that", "après cela", "sequence", "After that, we can eat.", "Après cela, nous pouvons manger."),
  concept("next-to", "A2", "expression", "next to", "à côté de", "place", "The café is next to the bank.", "Le café est à côté de la banque."),
  concept("across-from", "A2", "expression", "across from", "en face de", "place", "The hotel is across from the station.", "L'hôtel est en face de la gare."),
  concept("too-much", "A2", "expression", "too much", "trop", "quantity", "This bag costs too much.", "Ce sac coûte trop cher."),
  concept("enough", "A2", "word", "enough", "assez", "quantity", "We have enough time.", "Nous avons assez de temps."),
  ...
  concept("it-depends", "B1", "expression", "it depends", "ça dépend", "opinion", "It depends on the situation.", "Ça dépend de la situation."),
  concept("for-example", "B1", "expression", "for example", "par exemple", "explanation", "For example, we could start earlier.", "Par exemple, nous pourrions commencer plus tôt."),
  concept("as-a-result", "B1", "expression", "as a result", "par conséquent", "consequence", "The road was closed; as a result, we were late.", "La route était fermée ; par conséquent, nous étions en retard."),
  concept("since-then", "B1", "expression", "since then", "depuis lors", "storytelling", "I moved here in 2020 and have stayed since then.", "J'ai déménagé ici en 2020 et j'y suis resté depuis."),
  concept("find-out", "B1", "phrasal_verb", "find out", "découvrir", "discovery", "I found out about the event yesterday.", "J'ai découvert l'événement hier."),
  concept("give-up", "B1", "phrasal_verb", "give up", "abandonner", "effort", "I almost gave up, but I continued.", "J'ai failli abandonner, mais j'ai continué."),
  concept("look-forward-to", "B1", "phrasal_verb", "look forward to", "avoir hâte de", "plans", "I look forward to meeting the team.", "J'ai hâte de rencontrer l'équipe."),
  concept("be-used-to", "B1", "grammar", "be used to", "être habitué à", "adaptation", "I'm used to working early.", "J'ai l'habitude de travailler tôt."),
  concept("even-though", "B1", "grammar", "even though", "même si", "contrast", "Even though it was difficult, we finished.", "Même si c'était difficile, nous avons terminé."),
  concept("if-i-were-you", "B1", "construction", "If I were you…", "si j'étais toi…", "advice", "If I were you, I'd call first.", "Si j'étais toi, j'appellerais d'abord."),
  concept("might", "B1", "grammar", "might", "il se pourrait que", "possibility", "It might rain later.", "Il se pourrait qu'il pleuve plus tard."),
  concept("probably", "B1", "word", "probably", "probablement", "possibility", "She will probably arrive soon.", "Elle arrivera probablement bientôt."),
  ...
  concept("whereas", "B2", "word", "whereas", "tandis que", "contrast", "This option is fast, whereas the other is safer.", "Cette option est rapide, tandis que l'autre est plus sûre."),
  concept("despite", "B2", "word", "despite", "malgré", "contrast", "Despite the delay, the event went well.", "Malgré le retard, l'événement s'est bien passé."),
  concept("carry-out", "B2", "phrasal_verb", "carry out", "mener / effectuer", "work", "We need to carry out more tests.", "Nous devons effectuer davantage de tests."),
  concept("point-out", "B2", "phrasal_verb", "point out", "faire remarquer", "discussion", "She pointed out a serious risk.", "Elle a fait remarquer un risque sérieux."),
  concept("come-up-with", "B2", "phrasal_verb", "come up with", "trouver / proposer", "problem-solving", "We came up with a simpler solution.", "Nous avons trouvé une solution plus simple."),
  concept("take-into-account", "B2", "collocation", "take into account", "prendre en compte", "decision", "We must take the cost into account.", "Nous devons prendre le coût en compte."),
  concept("raise-an-issue", "B2", "collocation", "raise an issue", "soulever un problème", "discussion", "I'd like to raise an issue about timing.", "J'aimerais soulever un problème concernant le calendrier."),
  concept("reach-an-agreement", "B2", "collocation", "reach an agreement", "parvenir à un accord", "negotiation", "Both sides reached an agreement.", "Les deux parties sont parvenues à un accord."),
  concept("from-my-perspective", "B2", "expression", "from my perspective", "de mon point de vue", "opinion", "From my perspective, the benefits outweigh the risks.", "De mon point de vue, les avantages l'emportent sur les risques."),
  concept("on-balance", "B2", "expression", "on balance", "tout bien considéré", "opinion", "On balance, this is the better option.", "Tout bien considéré, c'est la meilleure option."),
  concept("tend-to", "B2", "grammar", "tend to", "avoir tendance à", "patterns", "People tend to choose the easiest route.", "Les gens ont tendance à choisir le chemin le plus facile."),
  concept("in-the-long-run", "B2", "expression", "in the long run", "à long terme", "consequence", "It will save money in the long run.", "Cela permettra d'économiser de l'argent à long terme."),
  ...
  concept("albeit", "C1", "word", "albeit", "quoique / bien que", "nuance", "The plan is promising, albeit expensive.", "Le plan est prometteur, quoique coûteux."),
  concept("insofar-as", "C1", "expression", "insofar as", "dans la mesure où", "nuance", "The policy works insofar as people understand it.", "La politique fonctionne dans la mesure où les gens la comprennent."),
  concept("by-and-large", "C1", "expression", "by and large", "dans l'ensemble", "synthesis", "By and large, the transition went smoothly.", "Dans l'ensemble, la transition s'est bien déroulée."),
  concept("shed-light-on", "C1", "collocation", "shed light on", "éclairer", "analysis", "The report sheds light on the underlying problem.", "Le rapport éclaire le problème sous-jacent."),
  concept("call-into-question", "C1", "collocation", "call into question", "remettre en question", "analysis", "These results call the initial assumption into question.", "Ces résultats remettent en question l'hypothèse initiale."),
  concept("bear-in-mind", "C1", "expression", "bear in mind", "garder à l'esprit", "decision", "Bear in mind that the figures are provisional.", "Gardez à l'esprit que les chiffres sont provisoires."),
  concept("pave-the-way", "C1", "collocation", "pave the way", "ouvrir la voie", "change", "The agreement paved the way for reform.", "L'accord a ouvert la voie à la réforme."),
  concept("far-reaching", "C1", "word", "far-reaching", "de grande portée", "impact", "The decision may have far-reaching consequences.", "La décision peut avoir des conséquences de grande portée."),
  concept("viable", "C1", "word", "viable", "viable", "decision", "We need a financially viable alternative.", "Nous avons besoin d'une alternative financièrement viable."),
  concept("ambiguity", "C1", "word", "ambiguity", "ambiguïté", "analysis", "The wording leaves considerable ambiguity.", "La formulation laisse une ambiguïté considérable."),
  concept("coherent", "C1", "word", "coherent", "cohérent", "argument", "The evidence supports a coherent explanation.", "Les preuves étayent une explication cohérente."),
  concept("substantiate", "C1", "word", "substantiate", "étayer", "argument", "Can you substantiate that claim with evidence?", "Pouvez-vous étayer cette affirmation avec des preuves ?"),
  ...
  concept("notwithstanding", "C2", "word", "notwithstanding", "nonobstant / malgré", "rhetoric", "Notwithstanding these concerns, the proposal merits consideration.", "Malgré ces préoccupations, la proposition mérite d'être examinée."),
  concept("ostensibly", "C2", "word", "ostensibly", "en apparence", "subtext", "The measure was ostensibly temporary.", "La mesure était en apparence temporaire."),
  concept("tacit", "C2", "word", "tacit", "tacite", "subtext", "Their silence amounted to tacit approval.", "Leur silence équivalait à une approbation tacite."),
  concept("equivocal", "C2", "word", "equivocal", "équivoque", "subtext", "Her response was deliberately equivocal.", "Sa réponse était délibérément équivoque."),
  concept("fallacy", "C2", "word", "fallacy", "raisonnement fallacieux", "argument", "The argument rests on a common fallacy.", "L'argument repose sur un raisonnement fallacieux courant."),
  concept("false-dichotomy", "C2", "collocation", "false dichotomy", "faux dilemme", "argument", "Presenting only two options creates a false dichotomy.", "Ne présenter que deux options crée un faux dilemme."),
  concept("nuanced", "C2", "word", "nuanced", "nuancé", "rhetoric", "The issue requires a more nuanced interpretation.", "La question exige une interprétation plus nuancée."),
  concept("extrapolate", "C2", "word", "extrapolate", "extrapoler", "analysis", "We should not extrapolate from a single case.", "Nous ne devrions pas extrapoler à partir d'un seul cas."),
  concept("undermine", "C2", "word", "undermine", "saper / fragiliser", "argument", "That contradiction undermines the central claim.", "Cette contradiction fragilise l'affirmation centrale."),
  concept("juxtapose", "C2", "word", "juxtapose", "juxtaposer", "rhetoric", "The author juxtaposes optimism with quiet despair.", "L'auteur juxtapose l'optimisme à un désespoir discret."),
  concept("salient", "C2", "word", "salient", "saillant / essentiel", "analysis", "The most salient point has been overlooked.", "Le point le plus saillant a été négligé."),
  concept("counterintuitive", "C2", "word", "counterintuitive", "contre-intuitif", "analysis", "The result is counterintuitive but well supported.", "Le résultat est contre-intuitif mais bien étayé."),
];
